...
- [Skip to main content](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management#content)
- [Skip to search](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management#search)
...
- [Color picker](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_colors/Color_picker)
...
- [Deutsch](https://developer.mozilla.org/de/docs/Mozilla/Add-ons/WebExtensions/API/management)
- [English (US)](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management)
- [Français](https://developer.mozilla.org/fr/docs/Mozilla/Add-ons/WebExtensions/API/management)
- [日本語](https://developer.mozilla.org/ja/docs/Mozilla/Add-ons/WebExtensions/API/management)
- [中文 (简体)](https://developer.mozilla.org/zh-CN/docs/Mozilla/Add-ons/WebExtensions/API/management)
...
Most of these operations require the "management" [API permission](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/manifest.json/permissions). Operations that don't provide access to other add-ons don't require this permission.

## In this article

- [Types](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management#types)
- [Functions](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management#functions)
- [Events](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management#events)
- [Example extensions](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management#example_extensions)
- [Browser compatibility](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management#browser_compatibility)

## [Types](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management\#types)

[`management.ExtensionInfo`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/ExtensionInfo)

An object that contains information about an installed add-on.

## [Functions](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management\#functions)

[`management.getAll()`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/getAll)

Returns information about all installed add-ons.

[`management.get()`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/get)

Returns information about a particular add-on, given its ID.

[`management.getSelf()`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/getSelf)

Returns information about the calling add-on.

[`management.install()`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/install)

Installs a particular theme, given its URL at [addons.mozilla.org](https://addons.mozilla.org/).

[`management.uninstall()`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/uninstall)

Uninstalls a particular add-on, given its ID.

[`management.uninstallSelf()`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/uninstallSelf)

Uninstalls the calling add-on.

[`management.getPermissionWarningsById()`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/getPermissionWarningsById)

Get the set of permission warnings for a particular add-on, given its ID.

[`management.getPermissionWarningsByManifest()`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/getPermissionWarningsByManifest)

Get the set of permission warnings that would be displayed for the given manifest string.

[`management.setEnabled()`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/setEnabled)

Enable/disable a particular add-on, given its ID.

## [Events](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management\#events)

[`management.onInstalled`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/onInstalled)

Fired when an add-on is installed.

[`management.onUninstalled`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/onUninstalled)

Fired when an add-on is uninstalled.

[`management.onEnabled`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/onEnabled)

Fired when an add-on is enabled.

[`management.onDisabled`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/onDisabled)
...
[Report problems with this compatibility data](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management# "Report an issue with this compatibility data") •
...
| [`getSelf`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/getSelf) | Chrome – Full support<br>Chrome58<br>Chrome – Full support<br>Chrome58 (Release date: ⁨2017-04-19⁩)<br> <br>footnoteFull support | Edge – Full support<br>Edge79<br>Edge – Full support<br>Edge79 (Release date: ⁨2020-01-15⁩)<br> <br>footnoteFull support | Firefox – Full support<br>Firefox51<br>Firefox – Full support<br>Firefox51 (Release date: ⁨2017-01-24⁩)<br> <br>footnoteFull support | Opera – Full support<br>Opera45<br>Opera – Full support<br>Opera45 (Release date: ⁨2017-05-10⁩)<br> <br>footnoteFull support | Safari – No support<br>SafariNo<br> <br>Safari – No support<br>Safari<br>footnoteNo support | Firefox for Android – Full support<br>Firefox for Android51<br>Firefox for Android – Full support<br>Firefox for Android51 (Release date: ⁨2017-01-24⁩)<br> <br>footnoteFull support | Safari on iOS – No support<br>Safari on iOSNo<br> <br>Safari on iOS – No support<br>Safari on iOS<br>footnoteNo support |
| [`install`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/install) | Chrome – No support<br>ChromeNo<br> <br>Chrome – No support<br>Chrome<br>footnoteNo support | Edge – No support<br>EdgeNo<br> <br>Edge – No support<br>Edge<br>footnoteNo support | Firefox – Full support<br>Firefox63<br>footnote<br>Firefox – Full support<br>Firefox63 (Release date: ⁨2018-10-23⁩)<br> <br>footnote<br>footnoteThe installable file pointed to by `url` must be a [theme](https://developer.mozilla.org/docs/Mozilla/Add-ons/Themes), and not a normal browser extension. | Opera – No support<br>OperaNo<br> <br>Opera – No support<br>Opera<br>footnoteNo support | Safari – No support<br>SafariNo<br> <br>Safari – No support<br>Safari<br>footnoteNo support | Firefox for Android – Full support<br>Firefox for Android63<br>footnote<br>Firefox for Android – Full support<br>Firefox for Android63 (Release date: ⁨2018-10-23⁩)<br> <br>footnote<br>footnoteThe installable file pointed to by `url` must be a [theme](https://developer.mozilla.org/docs/Mozilla/Add-ons/Themes), and not a normal browser extension. | Safari on iOS – No support<br>Safari on iOSNo<br> <br>Safari on iOS – No support<br>Safari on iOS<br>footnoteNo support |
| [`onDisabled`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/onDisabled) | Chrome – Full support<br>Chrome8<br>Chrome – Full support<br>Chrome8 (Release date: ⁨2010-12-02⁩)<br> <br>footnoteFull support | Edge – Full support<br>Edge79<br>Edge – Full support<br>Edge79 (Release date: ⁨2020-01-15⁩)<br> <br>footnoteFull support | Firefox – Full support<br>Firefox55<br>footnote<br>Firefox – Full support<br>Firefox55 (Release date: ⁨2017-08-08⁩)<br> <br>footnote<br>footnoteBefore version 56, only extensions whose `type` is `'theme'` are supported. | Opera – Full support<br>Opera15<br>Opera – Full support<br>Opera15 (Release date: ⁨2013-07-02⁩)<br> <br>footnoteFull support | Safari – No support<br>SafariNo<br> <br>Safari – No support<br>Safari<br>footnoteNo support | Firefox for Android – Full support<br>Firefox for Android55<br>footnote<br>Firefox for Android – Full support<br>Firefox for Android55 (Release date: ⁨2017-08-08⁩)<br> <br>footnote<br>footnoteBefore version 56, only extensions whose `type` is `'theme'` are supported. | Safari on iOS – No support<br>Safari on iOSNo<br> <br>Safari on iOS – No support<br>Safari on iOS<br>footnoteNo support |
| [`onEnabled`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/onEnabled) | Chrome – Full support<br>Chrome8<br>Chrome – Full support<br>Chrome8 (Release date: ⁨2010-12-02⁩)<br> <br>footnoteFull support | Edge – Full support<br>Edge79<br>Edge – Full support<br>Edge79 (Release date: ⁨2020-01-15⁩)<br> <br>footnoteFull support | Firefox – Full support<br>Firefox55<br>footnote<br>Firefox – Full support<br>Firefox55 (Release date: ⁨2017-08-08⁩)<br> <br>footnote<br>footnoteBefore version 56, only extensions whose `type` is `'theme'` are supported. | Opera – Full support<br>Opera15<br>Opera – Full support<br>Opera15 (Release date: ⁨2013-07-02⁩)<br> <br>footnoteFull support | Safari – No support<br>SafariNo<br> <br>Safari – No support<br>Safari<br>footnoteNo support | Firefox for Android – Full support<br>Firefox for Android55<br>footnote<br>Firefox for Android – Full support<br>Firefox for Android55 (Release date: ⁨2017-08-08⁩)<br> <br>footnote<br>footnoteBefore version 56, only extensions whose `type` is `'theme'` are supported. | Safari on iOS – No support<br>Safari on iOSNo<br> <br>Safari on iOS – No support<br>Safari on iOS<br>footnoteNo support |
| [`onInstalled`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/onInstalled) | Chrome – Full support<br>Chrome8<br>Chrome – Full support<br>Chrome8 (Release date: ⁨2010-12-02⁩)<br> <br>footnoteFull support | Edge – Full support<br>Edge79<br>Edge – Full support<br>Edge79 (Release date: ⁨2020-01-15⁩)<br> <br>footnoteFull support | Firefox – Full support<br>Firefox55<br>footnote<br>Firefox – Full support<br>Firefox55 (Release date: ⁨2017-08-08⁩)<br> <br>footnote<br>footnoteBefore version 56, only extensions whose `type` is `'theme'` are supported. | Opera – Full support<br>Opera15<br>Opera – Full support<br>Opera15 (Release date: ⁨2013-07-02⁩)<br> <br>footnoteFull support | Safari – No support<br>SafariNo<br> <br>Safari – No support<br>Safari<br>footnoteNo support | Firefox for Android – Full support<br>Firefox for Android55<br>footnote<br>Firefox for Android – Full support<br>Firefox for Android55 (Release date: ⁨2017-08-08⁩)<br> <br>footnote<br>footnoteBefore version 56, only extensions whose `type` is `'theme'` are supported. | Safari on iOS – No support<br>Safari on iOSNo<br> <br>Safari on iOS – No support<br>Safari on iOS<br>footnoteNo support |
| [`onUninstalled`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/onUninstalled) | Chrome – Full support<br>Chrome8<br>Chrome – Full support<br>Chrome8 (Release date: ⁨2010-12-02⁩)<br> <br>footnoteFull support | Edge – Full support<br>Edge79<br>Edge – Full support<br>Edge79 (Release date: ⁨2020-01-15⁩)<br> <br>footnoteFull support | Firefox – Full support<br>Firefox55<br>footnote<br>Firefox – Full support<br>Firefox55 (Release date: ⁨2017-08-08⁩)<br> <br>footnote<br>footnoteBefore version 56, only extensions whose `type` is `'theme'` are supported.footnoteThis event is not fired when the extension is in the "pending uninstall" state. The event is fired as expected once the extension is completely removed (for example, when the `about:addons` tab is closed). | Opera – Full support<br>Opera15<br>Opera – Full support<br>Opera15 (Release date: ⁨2013-07-02⁩)<br> <br>footnoteFull support | Safari – No support<br>SafariNo<br> <br>Safari – No support<br>Safari<br>footnoteNo support | Firefox for Android – Full support<br>Firefox for Android55<br>footnote<br>Firefox for Android – Full support<br>Firefox for Android55 (Release date: ⁨2017-08-08⁩)<br> <br>footnote<br>footnoteBefore version 56, only extensions whose `type` is `'theme'` are supported.footnoteThis event is not fired when the extension is in the "pending uninstall" state. The event is fired as expected once the extension is completely removed (for example, when the `about:addons` tab is closed). | Safari on iOS – No support<br>Safari on iOSNo<br> <br>Safari on iOS – No support<br>Safari on iOS<br>footnoteNo support |
| [`setEnabled`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/setEnabled) | Chrome – Full support<br>Chrome8<br>Chrome – Full support<br>Chrome8 (Release date: ⁨2010-12-02⁩)<br> <br>footnoteFull support | Edge – Full support<br>Edge79<br>Edge – Full support<br>Edge79 (Release date: ⁨2020-01-15⁩)<br> <br>footnoteFull support | Firefox – Partial support<br>Firefox140<br>more<br>Firefox – Partial support<br>Firefox55 – 139 (Release date: ⁨2017-08-08⁩)<br> <br>footnotePartial supportfootnoteExtensions can only enable and disable themes.<br>Firefox – Partial support<br>Firefox140 (Release date: ⁨2025-06-24⁩)<br> <br>footnotePartial supportfootnoteAny extension can enable and disable themes.footnoteExtensions installed via policies can enable and disable any extension. | Opera – Full support<br>Opera15<br>Opera – Full support<br>Opera15 (Release date: ⁨2013-07-02⁩)<br> <br>footnoteFull support | Safari – No support<br>SafariNo<br> <br>Safari – No support<br>Safari<br>footnoteNo support | Firefox for Android – Partial support<br>Firefox for Android140<br>more<br>Firefox for Android – Partial support<br>Firefox for Android55 – 139 (Release date: ⁨2017-08-08⁩)<br> <br>footnotePartial supportfootnoteExtensions can only enable and disable themes.<br>Firefox for Android – Partial support<br>Firefox for Android140 (Release date: ⁨2025-06-24⁩)<br> <br>footnotePartial supportfootnoteAny extension can enable and disable themes.footnoteExtensions installed via policies can enable and disable any extension. | Safari on iOS – No support<br>Safari on iOSNo<br> <br>Safari on iOS – No support<br>Safari on iOS<br>footnoteNo support |
| [`uninstall`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/uninstall) | Chrome – Full support<br>Chrome8<br>Chrome – Full support<br>Chrome8 (Release date: ⁨2010-12-02⁩)<br> <br>footnoteFull support | Edge – Full support<br>Edge79<br>Edge – Full support<br>Edge79 (Release date: ⁨2020-01-15⁩)<br> <br>footnoteFull support | Firefox – No support<br>FirefoxNo<br> <br>Firefox – No support<br>Firefox<br>footnoteNo support | Opera – Full support<br>Opera15<br>Opera – Full support<br>Opera15 (Release date: ⁨2013-07-02⁩)<br> <br>footnoteFull support | Safari – No support<br>SafariNo<br> <br>Safari – No support<br>Safari<br>footnoteNo support | Firefox for Android – No support<br>Firefox for AndroidNo<br> <br>Firefox for Android – No support<br>Firefox for Android<br>footnoteNo support | Safari on iOS – No support<br>Safari on iOSNo<br> <br>Safari on iOS – No support<br>Safari on iOS<br>footnoteNo support |
| [`uninstallSelf`](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/uninstallSelf) | Chrome – Full support<br>Chrome58<br>Chrome – Full support<br>Chrome58 (Release date: ⁨2017-04-19⁩)<br> <br>footnoteFull support | Edge – Full support<br>Edge79<br>Edge – Full support<br>Edge79 (Release date: ⁨2020-01-15⁩)<br> <br>footnoteFull support | Firefox – Full support<br>Firefox51<br>Firefox – Full support<br>Firefox51 (Release date: ⁨2017-01-24⁩)<br> <br>footnoteFull support | Opera – Full support<br>Opera45<br>Opera – Full support<br>Opera45 (Release date: ⁨2017-05-10⁩)<br> <br>footnoteFull support | Safari – No support<br>SafariNo<br> <br>Safari – No support<br>Safari<br>footnoteNo support | Firefox for Android – Full support<br>Firefox for Android51<br>Firefox for Android – Full support<br>Firefox for Android51 (Release date: ⁨2017-01-24⁩)<br> <br>footnoteFull support | Safari on iOS – No support<br>Safari on iOSNo<br> <br>Safari on iOS – No support<br>Safari on iOS<br>footnoteNo support |
| `uninstallSelf.dialogMessage` | Chrome – No support<br>ChromeNo<br> <br>Chrome – No support<br>Chrome<br>footnoteNo support | Edge – No support<br>EdgeNo<br> <br>Edge – No support<br>Edge<br>footnoteNo support | Firefox – Full support<br>Firefox51<br>Firefox – Full support<br>Firefox51 (Release date: ⁨2017-01-24⁩)<br> <br>footnoteFull support | Opera – No support<br>OperaNo<br> <br>Opera – No support<br>Opera<br>footnoteNo support | Safari – No support<br>SafariNo<br> <br>Safari – No support<br>Safari<br>footnoteNo support | Firefox for Android – Full support<br>Firefox for Android51<br>Firefox for Android – Full support<br>Firefox for Android51 (Release date: ⁨2017-01-24⁩)<br> <br>footnoteFull support | Safari on iOS – No support<br>Safari on iOSNo<br> <br>Safari on iOS – No support<br>Safari on iOS<br>footnoteNo support |
...
This page was last modified on ⁨Jul 17, 2025⁩ by [MDN contributors](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management/contributors.txt).


[View this page on GitHub](https://github.com/mdn/content/blob/main/files/en-us/mozilla/add-ons/webextensions/api/management/index.md?plain=1 "Folder: ⁨en-us/mozilla/add-ons/webextensions/api/management⁩ (Opens in a new tab)") • [Report a problem with this content](https://github.com/mdn/content/issues/new?template=page-report.yml&mdn-url=https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FMozilla%2FAdd-ons%2FWebExtensions%2FAPI%2Fmanagement&metadata=%3C%21--+Do+not+make+changes+below+this+line+--%3E%0A%3Cdetails%3E%0A%3Csummary%3EPage+report+details%3C%2Fsummary%3E%0A%0A*+Folder%3A+%60en-us%2Fmozilla%2Fadd-ons%2Fwebextensions%2Fapi%2Fmanagement%60%0A*+MDN+URL%3A+https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FMozilla%2FAdd-ons%2FWebExtensions%2FAPI%2Fmanagement%0A*+GitHub+URL%3A+https%3A%2F%2Fgithub.com%2Fmdn%2Fcontent%2Fblob%2Fmain%2Ffiles%2Fen-us%2Fmozilla%2Fadd-ons%2Fwebextensions%2Fapi%2Fmanagement%2Findex.md%0A*+Last+commit%3A+https%3A%2F%2Fgithub.com%2Fmdn%2Fcontent%2Fcommit%2F09109b6f9444d22215ba330ec1e64e73980b2a6c%0A*+Document+last+modified%3A+2025-07-17T07%3A48%3A12.000Z%0A%0A%3C%2Fdetails%3E "This will take you to GitHub to file a new issue.")
...
27. _[management](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/management)_
